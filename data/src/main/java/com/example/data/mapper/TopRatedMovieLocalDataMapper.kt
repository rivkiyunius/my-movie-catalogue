...
class TopRatedMovieLocalDataMapper @Inject constructor() :
    BaseDataMapper<DiscoverMovie, TopRatedMovieEntity>() {
    override fun mapToEntity(model: TopRatedMovieEntity): DiscoverMovie {
