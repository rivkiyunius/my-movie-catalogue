...
class SearchMovieRemoteDataMapper @Inject constructor() :
    BaseDataMapper<SearchMovieEntity, MovieData.Result>() {
    override fun mapToEntity(model: MovieData.Result): SearchMovieEntity {
