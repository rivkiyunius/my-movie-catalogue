...
class UpcomingMovieRemoteDataMapper @Inject constructor() :
    BaseDataMapper<UpcomingMovieEntity, MovieData.Result>() {
    override fun mapToEntity(model: MovieData.Result): UpcomingMovieEntity {
