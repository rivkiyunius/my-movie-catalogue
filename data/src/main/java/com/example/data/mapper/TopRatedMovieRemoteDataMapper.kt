...
class TopRatedMovieRemoteDataMapper @Inject constructor() :
    BaseDataMapper<TopRatedMovieEntity, MovieData.Result>() {
    override fun mapToEntity(model: MovieData.Result): TopRatedMovieEntity {
